...
QHash<QString, AsObject::AsEnumObjectType> &AsObject::m_lTypes(void) {
    ...
    if (hashTypes->isEmpty()) {
        ...
        hashTypes->insert("AsCmdOpenFromMyFlipcharts",
                          AsObject::AS_OBJECT_COMMAND_OPENFROMMYFLIPCHARTS);
        hashTypes->insert("AsCmdOpenFromSharedFlipcharts",
                          AsObject::AS_OBJECT_COMMAND_OPENFROMSHAREDFLIPCHARTS);
        hashTypes->insert("AsCmdOpenFromOtherLocation",
                          AsObject::AS_OBJECT_COMMAND_OPENFROMOTHERLOCATION);
        ...
        hashTypes->insert("AsCmdSaveToMyFlipcharts",
                          AsObject::AS_OBJECT_COMMAND_SAVETOMYFLIPCHARTS);
        hashTypes->insert("AsCmdSaveToSharedFlipcharts",
                          AsObject::AS_OBJECT_COMMAND_SAVETOSHAREDFLIPCHARTS);
        hashTypes->insert("AsCmdSaveToOtherLocation",
                          AsObject::AS_OBJECT_COMMAND_SAVETOOTHERLOCATION);
        ...
        hashTypes->insert("AsCmdCameraFullscreenCurrentPage",
                          AsObject::AS_OBJECT_COMMAND_CAMERA_FULLSCREEN_CURRENTPAGE);
        hashTypes->insert("AsCmdCameraFullscreenNewPage",
                          AsObject::AS_OBJECT_COMMAND_CAMERA_FULLSCREEN_NEWPAGE);
        ...
        hashTypes->insert("AsCmdMilitaryProtractor",
                          AsObject::AS_OBJECT_COMMAND_MILITARY_PROTRACTOR);
        ...
        hashTypes->insert("AsCmdShowExpressPollFlipchart",
                          AsObject::AS_OBJECT_COMMAND_SHOWEXPRESSPOLLFLIPCHART);
        ...
        hashTypes->insert("AsCmdSpotlightSquareReversed",
                          AsObject::AS_OBJECT_COMMAND_SPOTLIGHT_SQUAREREVERSED);
        ...
        hashTypes->insert("AsCmdConvertAnnotationToText",
                          AsObject::AS_OBJECT_COMMAND_CONVERTANNOTATIONTOTEXT);
        hashTypes->insert("AsCmdConvertAnnotationToShape",
                          AsObject::AS_OBJECT_COMMAND_CONVERTANNOTATIONTOSHAPE);
        ...
        hashTypes->insert("AsCmdInsertEmbeddedHtmlFragment",
                          AsObject::AS_OBJECT_COMMAND_INSERT_EMBEDDED_HTML_FRAGMENT);
        hashTypes->insert("AsCmdInsertLinkOnCurrentSelection",
                          AsObject::AS_OBJECT_COMMAND_INSERTLINK_CURRENTSELECTION);
        ...
        hashTypes->insert("AsCmdInsertPageDesktopSnapshot",
                          AsObject::AS_OBJECT_COMMAND_INSERTPAGE_DESKTOPSNAPSHOT);
        hashTypes->insert("AsCmdSetPageBackground", AsObject::AS_OBJECT_COMMAND_SETPAGEBACKGROUND);
        hashTypes->insert("AsCmdSavePageToResources",
                          AsObject::AS_OBJECT_COMMAND_SAVEPAGETORESOURCES);
        hashTypes->insert("AsCmdSaveBackgroundToResources",
                          AsObject::AS_OBJECT_COMMAND_SAVEBACKGROUNDTORESOURCES);
        hashTypes->insert("AsCmdSaveGridToResources",
                          AsObject::AS_OBJECT_COMMAND_SAVEGRIDTORESOURCES);
        ...
        hashTypes->insert("AsCmdClearFlipchartsMRUList",
                          AsObject::AS_OBJECT_COMMAND_CLEARFLIPCHARTSMRULIST);
        ...
        hashTypes->insert("AsCmdObjectIncreaseSize",
                          AsObject::AS_OBJECT_COMMAND_OBJECTINCREASESIZE);
        hashTypes->insert("AsCmdObjectDecreaseSize",
                          AsObject::AS_OBJECT_COMMAND_OBJECTDECREASESIZE);
        hashTypes->insert("AsCmdObjectOriginalSize",
                          AsObject::AS_OBJECT_COMMAND_OBJECTORIGINALSIZE);
        hashTypes->insert("AsCmdObjectBestFitWidth",
                          AsObject::AS_OBJECT_COMMAND_OBJECTBESTFITWIDTH);
        hashTypes->insert("AsCmdObjectBestFitHeight",
                          AsObject::AS_OBJECT_COMMAND_OBJECTBESTFITHEIGHT);
        ...
        hashTypes->insert("AsCmdFullScreenRecorder",
                          AsObject::AS_OBJECT_COMMAND_FULLSCREENRECORDER);
        hashTypes->insert("AsCmdAreaScreenRecorder",
                          AsObject::AS_OBJECT_COMMAND_AREASCREENRECORDER);
        hashTypes->insert("AsCmdEditUserDefinedButtons",
                          AsObject::AS_OBJECT_COMMAND_EDITUSERDEFINEDBUTTONS);
        hashTypes->insert("AsCmdCameraPointToPoint",
                          AsObject::AS_OBJECT_COMMAND_CAMERA_POINTTOPOINT);
        ...
        hashTypes->insert("AsCmdSpellcheckFlipchart",
                          AsObject::AS_OBJECT_COMMAND_SPELLCHECK_FLIPCHART);
        ...
        hashTypes->insert("AsCmdDuplicatePageAfterCurrent",
                          AsObject::AS_OBJECT_COMMAND_DUPLICATE_PAGEAFTERCURRENT);
        hashTypes->insert("AsCmdDuplicatePageBeforeCurrent",
                          AsObject::AS_OBJECT_COMMAND_DUPLICATE_PAGEBEFORECURRENT);
        hashTypes->insert("AsCmdDuplicatePageAtEndOfFlipchart",
                          AsObject::AS_OBJECT_COMMAND_DUPLICATE_PAGEATEND);
        hashTypes->insert("AsCmdInsertPageBlankBeforeCurrent",
                          AsObject::AS_OBJECT_COMMAND_INSERTPAGE_BLANKBEFORECURRENT);
        hashTypes->insert("AsCmdPageHistoryBack", AsObject::AS_OBJECT_COMMAND_PAGEHISTORYBACK);
        hashTypes->insert("AsCmdPageHistoryForward",
                          AsObject::AS_OBJECT_COMMAND_PAGEHISTORYFORWARD);
        hashTypes->insert("AsCmdAngle", AsObject::AS_OBJECT_COMMAND_ANGLE);
        hashTypes->insert("AsCmdAngleIncrementally",
                          AsObject::AS_OBJECT_COMMAND_ANGLEINCREMENTALLY);
        ...
        hashTypes->insert("AsCmdCameraFullscreenMyResLibrary",
                          AsObject::AS_OBJECT_COMMAND_CAMERA_FULLSCREEN_MYRESLIB);
        hashTypes->insert("AsCmdCameraFullscreenSharedResLibrary",
                          AsObject::AS_OBJECT_COMMAND_CAMERA_FULLSCREEN_SHAREDRESLIB);
        hashTypes->insert("AsCmdCameraFullscreenClipboard",
                          AsObject::AS_OBJECT_COMMAND_CAMERA_FULLSCREEN_CLIPBOARD);
        ...
        hashTypes->insert("AsCmdSizeObjectTopRight",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_TOPRIGHT);
        ...
        hashTypes->insert("AsCmdSizeObjectBottomLeft",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_BOTTOMLEFT);
        hashTypes->insert("AsCmdSizeObjectBottom", AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_BOTTOM);
        hashTypes->insert("AsCmdSizeObjectBottomRight",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_BOTTOMRIGHT);
        hashTypes->insert("AsCmdSizeObjectTopLeftIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_TOPLEFT_INCR);
        hashTypes->insert("AsCmdSizeObjectTopIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_TOP_INCR);
        hashTypes->insert("AsCmdSizeObjectTopRightIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_TOPRIGHT_INCR);
        hashTypes->insert("AsCmdSizeObjectLeftIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_LEFT_INCR);
        hashTypes->insert("AsCmdSizeObjectCentralIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_CENTRAL_INCR);
        hashTypes->insert("AsCmdSizeObjectRightIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_RIGHT_INCR);
        hashTypes->insert("AsCmdSizeObjectBottomLeftIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_BOTTOMLEFT_INCR);
        hashTypes->insert("AsCmdSizeObjectBottomIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_BOTTOM_INCR);
        hashTypes->insert("AsCmdSizeObjectBottomRightIncr",
                          AsObject::AS_OBJECT_COMMAND_SIZEOBJECT_BOTTOMRIGHT_INCR);
        hashTypes->insert("AsCmdStretchObjectTopLeft",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_TOPLEFT);
        hashTypes->insert("AsCmdStretchObjectTop", AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_TOP);
        hashTypes->insert("AsCmdStretchObjectTopRight",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_TOPRIGHT);
        hashTypes->insert("AsCmdStretchObjectLeft", AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_LEFT);
        hashTypes->insert("AsCmdStretchObjectCentral",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_CENTRAL);
        hashTypes->insert("AsCmdStretchObjectRight",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_RIGHT);
        hashTypes->insert("AsCmdStretchObjectBottomLeft",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_BOTTOMLEFT);
        hashTypes->insert("AsCmdStretchObjectBottom",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_BOTTOM);
        hashTypes->insert("AsCmdStretchObjectBottomRight",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_BOTTOMRIGHT);
        hashTypes->insert("AsCmdStretchObjectTopLeftIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_TOPLEFT_INCR);
        hashTypes->insert("AsCmdStretchObjectTopIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_TOP_INCR);
        hashTypes->insert("AsCmdStretchObjectTopRightIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_TOPRIGHT_INCR);
        hashTypes->insert("AsCmdStretchObjectLeftIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_LEFT_INCR);
        hashTypes->insert("AsCmdStretchObjectCentralIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_CENTRAL_INCR);
        hashTypes->insert("AsCmdStretchObjectRightIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_RIGHT_INCR);
        hashTypes->insert("AsCmdStretchObjectBottomLeftIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_BOTTOMLEFT_INCR);
        hashTypes->insert("AsCmdStretchObjectBottomIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_BOTTOM_INCR);
        hashTypes->insert("AsCmdStretchObjectBottomRightIncr",
                          AsObject::AS_OBJECT_COMMAND_STRETCHOBJECT_BOTTOMRIGHT_INCR);
        hashTypes->insert("AsCmdPositionObjectTopLeft",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_TOPLEFT);
        hashTypes->insert("AsCmdPositionObjectTop", AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_TOP);
        hashTypes->insert("AsCmdPositionObjectTopRight",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_TOPRIGHT);
        hashTypes->insert("AsCmdPositionObjectLeft",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_LEFT);
        hashTypes->insert("AsCmdPositionObjectCentral",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_CENTRAL);
        hashTypes->insert("AsCmdPositionObjectRight",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_RIGHT);
        hashTypes->insert("AsCmdPositionObjectBottomLeft",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_BOTTOMLEFT);
        hashTypes->insert("AsCmdPositionObjectBottom",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_BOTTOM);
        hashTypes->insert("AsCmdPositionObjectBottomRight",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_BOTTOMRIGHT);
        hashTypes->insert("AsCmdPositionObjectIncrementally",
                          AsObject::AS_OBJECT_COMMAND_POSITIONOBJECT_INCREMENTALLY);
        hashTypes->insert("AsCmdImportResourcePackToMyResLib",
                          AsObject::AS_OBJECT_COMMAND_IMPORTRESOURCEPACKTOMYRESLIB);
        hashTypes->insert("AsCmdImportResourcePackToSharedResLib",
                          AsObject::AS_OBJECT_COMMAND_IMPORTRESOURCEPACKTOSHAREDRESLIB);
        hashTypes->insert("AsCmdWebUpdate", AsObject::AS_OBJECT_COMMAND_WEBUPDATE);
        hashTypes->insert("AsCmdEditStudentDatabase",
                          AsObject::AS_OBJECT_COMMAND_EDITSTUDENTDATABASE);
        ...
        hashTypes->insert("AsCmdRevealerRevealNorth",
                          AsObject::AS_OBJECT_COMMAND_REVEALER_REVEAL_NORTH);
        hashTypes->insert("AsCmdRevealerRevealEast",
                          AsObject::AS_OBJECT_COMMAND_REVEALER_REVEAL_EAST);
        hashTypes->insert("AsCmdRevealerRevealSouth",
                          AsObject::AS_OBJECT_COMMAND_REVEALER_REVEAL_SOUTH);
        hashTypes->insert("AsCmdRevealerRevealWest",
                          AsObject::AS_OBJECT_COMMAND_REVEALER_REVEAL_WEST);
        ...
        hashTypes->insert("AsCmdDesignModeSettings",
                          AsObject::AS_OBJECT_COMMAND_DESIGNMODESETTINGS);
        ...
        hashTypes->insert("AsCmdAssignStudentsToDevices",
                          AsObject::AS_OBJECT_COMMAND_ASSIGNSTUDENTSTODEVICES);
        hashTypes->insert("AsCmdShowPageTransitions",
                          AsObject::AS_OBJECT_COMMAND_SHOWPAGETRANSITIONS);
        ...
        hashTypes->insert("AsCmdBrdRightMouseClick",
                          AsObject::AS_OBJECT_COMMAND_BRD_RIGHT_MOUSE_CLICK);
        ...
        hashTypes->insert("AsCmdBrdToolBoxSettings",
                          AsObject::AS_OBJECT_COMMAND_BRD_TOOLBOXSETTINGS);
        ...
        hashTypes->insert("AsCmdBrdDesktopAnnotate",
                          AsObject::AS_OBJECT_COMMAND_BRD_DESKTOP_ANNOTATE);
        ...
        hashTypes->insert("AsCmdTrainingAndSupportWebsite",
                          AsObject::AS_OBJECT_COMMAND_TRAINING_AND_SUPPORT_WEBSITE);
        hashTypes->insert("AsCmdBrowserShrinkThumbs",
                          AsObject::AS_OBJECT_COMMAND_BROWSER_SHRINKTHUMBS);
        hashTypes->insert("AsCmdBrowserGrowThumbs", AsObject::AS_OBJECT_COMMAND_BROWSER_GROWTHUMBS);
        hashTypes->insert("AsCmdConvertPPTAsImages",
                          AsObject::AS_OBJECT_COMMAND_CONVERTPPT_ASIMAGES);
        hashTypes->insert("AsCmdConvertPPTAsObjects",
                          AsObject::AS_OBJECT_COMMAND_CONVERTPPT_ASOBJECTS);
        hashTypes->insert("AsCmdScreenSizeFlipchart",
                          AsObject::AS_OBJECT_COMMAND_SCREENSIZE_FLIPCHART);
        hashTypes->insert("AsCmd1280X1024Flipchart",
                          AsObject::AS_OBJECT_COMMAND_1280X1024_FLIPCHART);
        ...
        hashTypes->insert("AsCmdCustomSizeFlipchart",
                          AsObject::AS_OBJECT_COMMAND_CUSTOMSIZE_FLIPCHART);
        hashTypes->insert("AsCmdImportSmartFile", AsObject::AS_OBJECT_COMMAND_SMART_IMPORT);
        hashTypes->insert("AsCmdImportSmartGallery",
                          AsObject::AS_OBJECT_COMMAND_SMART_GALLERY_IMPORT);
        ...
        hashTypes->insert("AsCmdPenModifierHorizontalLine",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_HORIZONTAL_LINE);
        hashTypes->insert("AsCmdPenModifierVerticalLine",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_VERTICAL_LINE);
        hashTypes->insert("AsCmdPenModifierSquare", AsObject::AS_OBJECT_COMMAND_PENMODIFIER_SQUARE);
        hashTypes->insert("AsCmdPenModifierRectangle",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_RECTANGLE);
        hashTypes->insert("AsCmdPenModifierCircle", AsObject::AS_OBJECT_COMMAND_PENMODIFIER_CIRCLE);
        hashTypes->insert("AsCmdPenModifierEllipse",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_ELLIPSE);
        hashTypes->insert("AsCmdPenModifierCurve", AsObject::AS_OBJECT_COMMAND_PENMODIFIER_CURVE);
        hashTypes->insert("AsCmdPenModifierSemiCircle",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_SEMICIRCLE);
        hashTypes->insert("AsCmdPenModifierCallout1",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_CALLOUT1);
        hashTypes->insert("AsCmdPenModifierCallout2",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_CALLOUT2);
        hashTypes->insert("AsCmdPenModifierLine", AsObject::AS_OBJECT_COMMAND_PENMODIFIER_LINE);
        hashTypes->insert("AsCmdPenModifierSquare", AsObject::AS_OBJECT_COMMAND_PENMODIFIER_SQUARE);
        hashTypes->insert("AsCmdPenModifierLineChainShape",
                          AsObject::AS_OBJECT_COMMAND_PENMODIFIER_LINE_CHAIN);

        // marquee handles
        hashTypes->insert("AsCmdMarqueeSizeTopLeft",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZETOPLEFT);
        hashTypes->insert("AsCmdMarqueeSizeTopCentre",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZETOPCENTRE);
        hashTypes->insert("AsCmdMarqueeSizeTopRight",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZETOPRIGHT);
        hashTypes->insert("AsCmdMarqueeSizeLeftCentre",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZELEFTCENTRE);
        hashTypes->insert("AsCmdMarqueeSizeRightCentre",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZERIGHTCENTRE);
        hashTypes->insert("AsCmdMarqueeSizeBottomLeft",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZEBOTTOMLEFT);
        hashTypes->insert("AsCmdMarqueeSizeBottomCentre",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZEBOTTOMCENTRE);
        hashTypes->insert("AsCmdMarqueeSizeBottomRight",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_SIZEBOTTOMRIGHT);
        ...
        hashTypes->insert("AsCmdMarqueeContextMenu",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_CONTEXTMENU);
        hashTypes->insert("AsCmdMarqueeTransparencySlider",
                          AsObject::AS_OBJECT_COMMAND_MARQUEE_TRANSPARENCYSLIDER);
        ...
        // Export all pages
        hashTypes->insert("AsCmdExportAllPagesToJPEG",
                          AsObject::AS_OBJECT_COMMAND_ALL_PAGES_EXPORT_TO_JPEG);
        hashTypes->insert("AsCmdExportAllPagesToBMP",
                          AsObject::AS_OBJECT_COMMAND_ALL_PAGES_EXPORT_TO_BMP);
        hashTypes->insert("AsCmdExportAllPagesToPDF",
                          AsObject::AS_OBJECT_COMMAND_ALL_PAGES_EXPORT_TO_PDF);

        // Change look and feel
        hashTypes->insert("AsCmdLookAndFeelStudio",
                          AsObject::AS_OBJECT_COMMAND_LOOK_AND_FEEL_STUDIO);
        hashTypes->insert("AsCmdLookAndFeelPrimary",
                          AsObject::AS_OBJECT_COMMAND_LOOK_AND_FEEL_PRIMARY);
    }
